...
export function getSandboxTpl(tpl: string, previewLocal: boolean): string | object {
  const files: IFiles = {
    ...
    "package.json": {
      isBinary: false,
      code: `{"name":"element-plus-test-template","version":"0.0.0","scripts":{"dev":"vite","build":"vite build","serve":"vite preview"},"dependencies":{"@vitejs/plugin-vue":"^1.1.5","@vue/compiler-sfc":"^3.0.7","element-plus":"1.1.0-beta.24","typescript":"4.4.4","unplugin-vue-components":"0.16.0","vite":"^2.0.5","vue":"3.2.20"},"keywords":[],"description":""}`,
    },
    "pnpm-lock.yaml": {
      isBinary: false,
      code: `dependencies:
